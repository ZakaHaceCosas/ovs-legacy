<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        ...
        <form class="d-flex" role="search" action="search.php" method="GET" id="rechercheForm">
            <input class="form-control me-2" type="search" placeholder="Recherche" name="query" id="query" aria-label="Recherche" pattern="^\S.*$" oninvalid="this.setCustomValidity('Veuillez saisir une requête de recherche valide.')" oninput="setCustomValidity('')" autocomplete="off">
